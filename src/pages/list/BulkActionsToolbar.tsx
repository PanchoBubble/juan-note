        ...
        <div className="flex items-center gap-2">
          ...
          {onUpdatePriority && (
            <div className="flex items-center gap-1">
              <span className="text-sm text-monokai-comment mr-2">
                Priority:
              </span>
              {[1, 2, 3, 4, 5].map(priority => (
                <button
                  ...
                  className={`px-2 py-1 text-xs rounded border transition-colors ${
                    priority === 1
                      ? "border-monokai-red text-monokai-red hover:bg-monokai-red hover:bg-opacity-20"
                      : priority === 2
                        ? "border-monokai-orange text-monokai-orange hover:bg-monokai-orange hover:bg-opacity-20"
                        : priority === 3
                          ? "border-monokai-yellow text-monokai-yellow hover:bg-monokai-yellow hover:bg-opacity-20"
                          : priority === 4
                            ? "border-monokai-green text-monokai-green hover:bg-monokai-green hover:bg-opacity-20"
