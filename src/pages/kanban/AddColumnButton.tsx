  ...
  if (compact) {
    return (
      <button
        ...
        onClick={onClick}
        disabled={disabled}
        className={`inline-flex items-center justify-center w-10 h-10 rounded-lg border-2 border-dashed transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-monokai-blue focus:ring-opacity-50 ${
          disabled
            ? "border-monokai border-opacity-20 text-monokai-comment cursor-not-allowed"
            : "border-monokai-blue border-opacity-40 text-monokai-blue hover:border-opacity-60 hover:bg-monokai-blue hover:bg-opacity-10"
        }`}
