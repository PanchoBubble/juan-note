      ...
      <div className="p-6">
        <div className="flex items-start space-x-3">
          <div className="flex-shrink-0">
            <svg
              className="w-6 h-6 text-monokai-green"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-monokai-comment mb-4">
              Are you sure you want to mark this note as complete? This will
              update its status and move it to the completed section.
            </p>
